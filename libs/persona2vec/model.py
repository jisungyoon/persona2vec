...
class Persona2Vec(object):
    ...
    def __init__(self, G,
        ...
        self.base_model = Node2Vec(self.original_network,
                                     directed=directed,
        ...
        self.persona_model = Node2Vec(self.persona_network,
                         directed=True,
        ...
        self.persona_model.initialize_persona_vectors(self.base_embedding, self.persona_to_node)
